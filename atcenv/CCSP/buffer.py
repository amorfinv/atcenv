"""
Replay Buffer for the Centralized Critic Shared Policy Algorithm
Single Buffer entry contains all available state observations for that timestep,
allowing for a centralized critic that learns from the joint observation set.

Based on the MASAC ReplayBuffer class.
"""
