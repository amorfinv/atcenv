...
class SAC:
    def __init__(self, alpha=0.0003, beta=0.0003, n_agents = 10, state_size = 8,
            input_dims=[8], actionbounds = 1, gamma=0.99, n_actions=2, max_size=1000000, tau=0.005,
    ...
    def learn(self):
        ...
        with tf.GradientTape() as tape:
            ...
            log_probs = tf.reshape(log_probs,[self.batch_size,self.n_agents*self.n_actions] )
